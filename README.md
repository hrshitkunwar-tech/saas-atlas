...
It's also part of the broader [Navigator](https://github.com/hrshitkunwar-tech/navigator) ecosystem. Navigator needs to know what SaaS tools exist and where their documentation lives. SaaS Atlas is that index, built as a public product.
