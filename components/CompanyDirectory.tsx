...
import { Search, X, ExternalLink, BookOpen, AlertCircle, Zap, Code, Grid3x3, ChevronRight, ArrowRight, Clock } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          ...
          <div className="relative">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search: 'stripe webhook', 'datadog setup', 'salesforce integration'"
                value={searchQuery}
            ...
            {showResults && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-xl z-50 max-h-96 overflow-y-auto">
                {searchQuery.trim() === '' ? (
                  <div className="p-4">
                    <p className="text-xs font-semibold text-gray-500 uppercase mb-3">Try searching:</p>
                    <div className="space-y-2">
                      {['stripe webhook', 'datadog setup', 'salesforce', 'slack api'].map((example, idx) => (
                        <button
                          key={idx}
              ...
              <div className="space-y-12">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 max-w-2xl mx-auto mb-8">
                    Search by product name, feature, error, or task. Instant access to documentation and guides.
                  </p>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {['Stripe', 'Datadog', 'HubSpot', 'Slack'].map((example, idx) => (
                      <button
                        key={idx}
                        onClick={() => performSearch(example)}
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-8 bg-white rounded-lg p-8 border border-gray-200">
                {[
                  ...
                  { title: 'API & SDK', desc: 'Reference documentation' },
              ...
              <div className="sticky top-24 space-y-6">
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div>
                      <p className="text-gray-500">Docs URL</p>
